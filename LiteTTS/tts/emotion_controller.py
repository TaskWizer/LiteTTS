...
class EmotionController:
    ...
    def _load_emotion_mappings(self) -> dict[str, EmotionMapping]:
        ...
        return {
            ...
            "happy": EmotionMapping(
                name="happy",
                weight_adjustments={"brightness": 0.3, "energy": 0.4, "warmth": 0.2},
            ...
            "sad": EmotionMapping(
                name="sad",
                weight_adjustments={"brightness": -0.4, "energy": -0.3, "warmth": -0.2},
            ...
            "angry": EmotionMapping(
                name="angry",
                weight_adjustments={"intensity": 0.5, "sharpness": 0.4, "energy": 0.3},
            ...
            "excited": EmotionMapping(
                name="excited",
                weight_adjustments={"energy": 0.6, "brightness": 0.4, "intensity": 0.3},
            ...
            "calm": EmotionMapping(
                name="calm",
                weight_adjustments={"smoothness": 0.4, "warmth": 0.3, "stability": 0.2},
                pitch_adjustment=-0.05,
            ...
            "confident": EmotionMapping(
                name="confident",
                weight_adjustments={"authority": 0.4, "clarity": 0.3, "stability": 0.3},
                pitch_adjustment=0.0,
                speed_adjustment=1.0,
            ...
            "gentle": EmotionMapping(
                name="gentle",
                weight_adjustments={"softness": 0.4, "warmth": 0.3, "smoothness": 0.2},
                pitch_adjustment=-0.1,
                speed_adjustment=0.9,
            ...
            "mysterious": EmotionMapping(
                name="mysterious",
                weight_adjustments={"depth": 0.3, "smoothness": 0.2, "intensity": 0.1},
                pitch_adjustment=-0.2,
            ...
            "playful": EmotionMapping(
                name="playful",
                weight_adjustments={"brightness": 0.3, "energy": 0.2, "variability": 0.3},
                pitch_adjustment=0.15,
    ...
    def apply_emotion(
        self, voice_embedding: np.ndarray, emotion: str, strength: float = 1.0
    ) -> np.ndarray:
    ...
    def blend_emotions(
        self, voice_embedding: np.ndarray, emotions: list[tuple[str, float]]
    ) -> np.ndarray:
        ...
        normalized_emotions = [
            (emotion, strength / total_strength) for emotion, strength in emotions
        ]
        ...
        for emotion, normalized_strength in normalized_emotions:
            if normalized_strength > 0:
                emotion_embedding = self.apply_emotion(
                    voice_embedding, emotion, normalized_strength
                )
                # Blend with current result
                blend_factor = normalized_strength
                result_embedding = (
                    result_embedding * (1 - blend_factor) + emotion_embedding * blend_factor
                )
