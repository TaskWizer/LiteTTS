...
class lib:
    ...
    def ggml_abs_inplace(ctx: ffi.CData, a: ffi.CData) -> ffi.CData:
        ...
        """
    def ggml_acc(
        ctx: ffi.CData, a: ffi.CData, b: ffi.CData, nb1: int, nb2: int, nb3: int, offset: int
    ) -> ffi.CData:
        """
    ...
    def ggml_add_inplace(ctx: ffi.CData, a: ffi.CData, b: ffi.CData) -> ffi.CData:
        ...
        """
    def ggml_alibi(
        ctx: ffi.CData, a: ffi.CData, n_past: int, n_head: int, bias_max: float
    ) -> ffi.CData:
        """
    ...
    def ggml_cl_mul_mat(
        src0: ffi.CData, src1: ffi.CData, dst: ffi.CData, wdata: ffi.CData, wsize: int
    ) -> None:
    ...
    def ggml_cont(ctx: ffi.CData, a: ffi.CData) -> ffi.CData:
        ...
        """
    def ggml_conv_1d(
        ctx: ffi.CData, a: ffi.CData, b: ffi.CData, s0: int, p0: int, d0: int
    ) -> ffi.CData:
        """
    ...
    def ggml_cross_entropy_loss_back(
        ctx: ffi.CData, a: ffi.CData, b: ffi.CData, c: ffi.CData
    ) -> ffi.CData:
        """
    ...
    def ggml_cuda_get_device_description(
        device: int, description: ffi.CData, description_size: int
    ) -> None:
    ...
    def ggml_elu_inplace(ctx: ffi.CData, a: ffi.CData) -> ffi.CData:
        ...
        """
    def ggml_flash_attn(
        ctx: ffi.CData, q: ffi.CData, k: ffi.CData, v: ffi.CData, masked: bool
    ) -> ffi.CData:
        """
    ...
    def ggml_flash_attn_back(
        ctx: ffi.CData, q: ffi.CData, k: ffi.CData, v: ffi.CData, d: ffi.CData, masked: bool
    ) -> ffi.CData:
        """
        ...
        """
    def ggml_flash_ff(
        ctx: ffi.CData, a: ffi.CData, b0: ffi.CData, b1: ffi.CData, c0: ffi.CData, c1: ffi.CData
    ) -> ffi.CData:
        """
    ...
    def ggml_map_binary_f32(
        ctx: ffi.CData, a: ffi.CData, b: ffi.CData, fun: ffi.CData
    ) -> ffi.CData:
        """
    ...
    def ggml_map_custom1(
        ctx: ffi.CData, a: ffi.CData, fun: ffi.CData, n_tasks: int, userdata: ffi.CData
    ) -> ffi.CData:
        """
    ...
    def ggml_map_custom3_f32(
        ctx: ffi.CData, a: ffi.CData, b: ffi.CData, c: ffi.CData, fun: ffi.CData
    ) -> ffi.CData:
        """
    ...
    def ggml_metal_add_buffer(
        ctx: ffi.CData, name: ffi.CData, data: ffi.CData, size: int, max_size: int
    ) -> bool:
        """
    ...
    def ggml_mpi_eval_init(
        ctx_mpi: ffi.CData, n_tokens: ffi.CData, n_past: ffi.CData, n_threads: ffi.CData
    ) -> None:
        """
    ...
    def ggml_new_tensor_4d(
        ctx: ffi.CData, type: int, ne0: int, ne1: int, ne2: int, ne3: int
    ) -> ffi.CData:
        """
    ...
    def ggml_opt_resume_g(
        ctx: ffi.CData, opt: ffi.CData, f: ffi.CData, gf: ffi.CData, gb: ffi.CData
    ) -> int:
        """
        continue optimizing the function defined by the tensor f
    ...
    def ggml_out_prod(ctx: ffi.CData, a: ffi.CData, b: ffi.CData) -> ffi.CData:
        ...
        """
    def ggml_permute(
        ctx: ffi.CData, a: ffi.CData, axis0: int, axis1: int, axis2: int, axis3: int
    ) -> ffi.CData:
        """
    ...
    def ggml_pool_1d(ctx: ffi.CData, a: ffi.CData, op: int, k0: int, s0: int, p0: int) -> ffi.CData:
        ...
        """
    def ggml_pool_2d(
        ctx: ffi.CData, a: ffi.CData, op: int, k0: int, k1: int, s0: int, s1: int, p0: int, p1: int
    ) -> ffi.CData:
        """
    ...
    def ggml_quantize_chunk(
        type: int, src: ffi.CData, dst: ffi.CData, start: int, n: int, hist: ffi.CData
    ) -> int:
    ...
    def ggml_reshape_3d(ctx: ffi.CData, a: ffi.CData, ne0: int, ne1: int, ne2: int) -> ffi.CData:
        ...
        """
    def ggml_reshape_4d(
        ctx: ffi.CData, a: ffi.CData, ne0: int, ne1: int, ne2: int, ne3: int
    ) -> ffi.CData:
        """
    ...
    def ggml_rms_norm_inplace(ctx: ffi.CData, a: ffi.CData, eps: float) -> ffi.CData:
        ...
        """
    def ggml_rope(
        ctx: ffi.CData, a: ffi.CData, n_past: int, n_dims: int, mode: int, n_ctx: int
    ) -> ffi.CData:
        """
    ...
    def ggml_set_2d_inplace(
        ctx: ffi.CData, a: ffi.CData, b: ffi.CData, nb1: int, offset: int
    ) -> ffi.CData:
        """
    ...
    def ggml_view_1d(ctx: ffi.CData, a: ffi.CData, ne0: int, offset: int) -> ffi.CData:
        ...
        """
    def ggml_view_2d(
        ctx: ffi.CData, a: ffi.CData, ne0: int, ne1: int, nb1: int, offset: int
    ) -> ffi.CData:
        """
        ...
        """
    def ggml_view_3d(
        ctx: ffi.CData, a: ffi.CData, ne0: int, ne1: int, ne2: int, nb1: int, nb2: int, offset: int
    ) -> ffi.CData:
        """
    ...
    def gguf_set_arr_data(
        ctx: ffi.CData, key: ffi.CData, type: int, data: ffi.CData, n: int
    ) -> None:
