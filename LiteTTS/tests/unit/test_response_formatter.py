...
class TestResponseFormatterEdgeCases:
    ...
    def test_format_with_zero_processing_time(self, formatter):
        ...
        audio = MockAudioSegment()
        result = formatter.format_audio_response(audio, "mp3", 0.0, False)
        assert result is not None
