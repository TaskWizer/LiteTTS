        ...
        return {
            ...
            "interjections": [
                (
                    "Hmm, let me think",
                    "Hum, let me think",
                    "hmm should become 'hum' with proper duration",
                ),
        ...
        return {
            "currency": [
                (
                    ...
                    "currency should be spelled out",
                ),
                (
                    "$5,681.52",
                ...
                (
                    "~$568.91",
                    "approximately five hundred sixty eight dollars and ninety one cents",
                    "approximate values",
                ),
            ...
            "dates_times": [
                ...
                (
                    ...
                    "ISO format should not say 'dash'",
                ),
                (
                    "November 21, 2025",
                    "November twenty-first, two thousand twenty five",
                    "ordinal dates",
                ),
            ],
            "urls": [
                ...
                (
                    "https://www.somesite.com/somepage",
                    "W-W-W some site dot com forward slash some page",
                    "path handling",
                ),
        ...
        return {
            "context_aware": [
                (
                    "Update my resume",
                    "Update my resume",
                    "resume should be 'REZ-oo-mey' (document)",
                ),
                (
                    "Resume the meeting",
                    "Resume the meeting",
                    "resume should be 're-ZOOM' (continue)",
                ),
            ...
            "emotional_prosodic": [
                ...
                (
                    "(whispered) secret",
                    "(whispered) secret",
                    "parentheses should trigger voice modulation",
                ),
    ...
    def test_critical_contraction_issues(self):
        ...
        for input_text, expected_output, description in self.critical_issues["contractions"]:
            with self.subTest(input_text=input_text):
                ...
                enhanced_text = (
                    enhanced_result.processed_text
