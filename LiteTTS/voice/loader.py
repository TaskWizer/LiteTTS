...
class VoiceLoader:
    ...
    def __init__(self, voices_dir: str, enable_mock: bool = False):
        ...
        # Statistics
        self.load_stats = {"torch_loads": 0, "numpy_loads": 0, "mock_loads": 0, "failed_loads": 0}

        logger.info(
            f"VoiceLoader initialized: torch={self.torch_available}, mock={self.enable_mock}"
        )
    ...
    def _load_with_torch(self, voice_name: str) -> VoiceLoadResult:
        ...
        try:
            ...
            if isinstance(model_data, dict):
                ...
                # Extract metadata
                metadata = {k: v for k, v in model_data.items() if not isinstance(v, torch.Tensor)}
            ...
            return VoiceLoadResult(
                success=True, embedding_data=embedding_data, metadata=metadata, loader_used="torch"
            )
    ...
    def _load_with_numpy(self, voice_name: str) -> VoiceLoadResult:
        ...
        try:
            ...
            return VoiceLoadResult(
                success=True, embedding_data=voice_data, metadata=metadata, loader_used="numpy"
            )
    ...
    def _load_mock_data(self, voice_name: str) -> VoiceLoadResult:
        ...
        try:
            ...
            return VoiceLoadResult(
                success=True, embedding_data=embedding_data, metadata=metadata, loader_used="mock"
            )
