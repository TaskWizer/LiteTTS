...
class CodeQualityAssessor:
        ...
        try:
            ...
            try:
                ...
                self.issues["structure"].append(
                    {"file": str(file_path), "issue": f"Syntax error: {e}", "severity": "high"}
                )
    ...
    def check_configuration_security(self) -> dict[str, Any]:
        ...
        config_analysis = {"config_files": [], "security_issues": [], "best_practices": []}
                    ...
                    if config_file.endswith(".json"):
                        try:
                            ...
                            config_analysis["best_practices"].append(
                                {"file": config_file, "practice": "Valid JSON format"}
                            )
