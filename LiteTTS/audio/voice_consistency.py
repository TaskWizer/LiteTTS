...
class VoiceConsistencyManager:
    ...
    def start_consistency_session(
        self, session_id: str, voice_id: str, text: str, generation_parameters: dict[str, Any]
    ) -> str:
        """
    ...
    def prepare_chunk_for_consistency(
        ...
        if overlap_text and self.consistency_level in [
            ConsistencyLevel.ENHANCED,
    ...
    def apply_consistency_adjustments(
        self, generation_parameters: dict[str, Any], consistency_info: ChunkConsistencyInfo
    ) -> dict[str, Any]:
        """
    ...
    def _extract_prosody_profile(
        self, reference_audio: bytes | None, base_parameters: dict[str, Any] | None
    ) -> dict[str, float]:
    ...
    def _analyze_text_for_consistency(self, text: str) -> dict[str, Any]:
        ...
        return {
            ...
            "complexity_score": (question_count + exclamation_count + emotion_score)
            / max(sentence_count, 1),
        }

    def _initialize_consistency_state(
        self, voice_profile: VoiceProfile, text_analysis: dict[str, Any]
    ) -> dict[str, Any]:
        ...
        return {
            ...
            "chunk_history": [],
            "drift_compensation": {"prosody_drift": 0.0, "timing_drift": 0.0, "energy_drift": 0.0},
        }
    ...
    def _calculate_energy_adjustments(
        self, chunk_text: str, chunk_position: int, consistency_state: dict[str, Any]
    ) -> dict[str, float]:
    ...
    def _calculate_overlap_compensation(
        self, overlap_text: str, chunk_text: str, consistency_state: dict[str, Any]
    ) -> dict[str, Any]:
