...
class LiteTTSApplication:
    ...
    async def lifespan(self, app: FastAPI):
        ...
        try:
            ...
            # DISABLED: Blocks startup for 90+ seconds
            # memory_results = memory_optimizer.run_comprehensive_optimization(target_memory)
            memory_results = {"success": False, "error": "Skipped for fast startup"}
        ...
        # DISABLED: Skip blocking performance optimizations for fast startup
        self.logger.info("⚡ Skipping performance optimizations for fast startup...")
